...
module "stevedore" {
  ...
  image_uri        = "public.ecr.aws/y8v9n2g8/stevedore:v1.2.3"
...
aws cloudformation deploy \
  ...
  --parameter-overrides \
    ...
    ImageUri=public.ecr.aws/y8v9n2g8/stevedore:v1.2.3 \
...
Update the `image` field to `public.ecr.aws/y8v9n2g8/stevedore:v1.2.3` and set `CLUSTER_NAME` to your cluster. Full manifest: [`examples/container/k8s-cronjob.yaml`](examples/container/k8s-cronjob.yaml)
